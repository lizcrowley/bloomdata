...
class Product:
    ...
    def stealability(self):
        '''Stealability method calculates the price devided by the weight and
        returns string based on how likely product will be to steal.'''
    ...
    def explode(self):
        '''Explode method calculates flammability multiplied by weight and
        returns string based on how likely the product is to explode.'''
    ...
    def __repr__(self):
        prod_list = (self.name,
                     ...
                     self.flammability)
        return f'{prod_list}'
        # return f'''{self.name} has the identifier {self.identifier} with a
        #           price of {self.price}, a weight of {self.weight}, and a
        #           flammability value of {self.flammability}.'''


class BoxingGlove(Product):

    '''Initializing the BoxingGlove class variables the same as the Product
    class but weight is defaulted at 10 instead of 20.'''
    ...
    def punch(self):
        '''Punch method returns string based on weight.'''
        if self.weight < 5:
            return "That tickles."
